public class Lab01_Q3_Revision {
    public static void main(String[] args) {
        ...
        // Furthermore on the existing code 
        final double turkeyWaterAreaPercToEarth= turkeyWaterAreaInt/totalEarthArea *100;
        ...
        System.out.println("Percentage of Turkey's water to the earth land " + turkeyWaterAreaPercToEarth + " percent");
    }
}
